...
@section('content')
    ...
    @foreach ($data_pelanggan_app_tegowanu as $data)
    ...
    <div class="container-fluid display-pelanggan-app" style="margin-top: 60px;">
        ...
        <form action="/hapusPelangganAPP" method="post">
            ...
            <div style="overflow-y: auto;">
                <table class="table-bordered display mt-2" id="tabel-pelanggan-app">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>
                    ...
                    <tbody>
                        @php
                            $no = 1;
                        @endphp
                        @foreach ($data_pelanggan_app_tegowanu as $app)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <div class="d-flex justify-content-center">
    ...
    <script>
        ...
        var data_pelanggan_app_tegowanu = @json($data_pelanggan_app_tegowanu);
        var currentMarker;
        ...
        addMarkers(data_pelanggan_app_tegowanu);
        ...
        function showSuggestions() {
            ...
            data_pelanggan_app_tegowanu.forEach(function(customer) {
        ...
        document.getElementById('filterButton').addEventListener('click', function() {
            ...
            if (startDate && endDate) {
                ...
                var filteredData = data_pelanggan_app_tegowanu.filter(function(customer) {
