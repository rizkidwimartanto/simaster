...
@section('content')
    ...
    @foreach ($data_pelanggan_app_purwodadi as $data)
    ...
    <div class="container-fluid display-pelanggan-app" style="margin-top: 60px;">
        <h1 class="text-center" style="font-weight: 700;">Pelanggan Purwodadi</h1>
        <div class="card p-3 mb-3">
            <div class="row">
                <div class="col-12">
                    <h2>Import Excel Data Pelanggan APP</h2>
                    <form action="/koordinator/import_excel_purwodadi" method="post" enctype="multipart/form-data">
                        @csrf
            ...
            <table class="table table-bordered tabel-app mt-2" id="tabel-pelanggan-app">
                ...
                <tbody>
                    @php
                        $no = 1;
                    @endphp
                    @foreach ($data_pelanggan_app_purwodadi as $app)
                        <tr>
                            <td width="5%">{{ $no++ }}</td>
                            <td width="2%">
                                <div class="d-flex justify-content-center">
    ...
    <script>
        ...
        var data_pelanggan_app_purwodadi = @json($data_pelanggan_app_purwodadi);
        var currentMarker;
        ...
        addMarkers(data_pelanggan_app_purwodadi);
        ...
        function showSuggestions() {
            ...
            data_pelanggan_app_purwodadi.forEach(function(customer) {
        ...
        document.getElementById('filterButton').addEventListener('click', function() {
            ...
            if (startDate && endDate) {
                ...
                var filteredData = data_pelanggan_app_purwodadi.filter(function(customer) {
