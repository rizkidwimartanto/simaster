...
@section('content')
    <div class="container-fluid mt-3">
        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapsePenyulangSection" aria-expanded="false"
                            aria-controls="collapsePenyulangSection">
                            Penyulang & Section
                        </button>
                    </h2>
                    <div id="collapsePenyulangSection" class="accordion-collapse collapse"
            ...
            <div class="card border border-info mt-2">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseDataPelanggan" aria-expanded="false"
                            aria-controls="collapseDataPelanggan">
                            Data Pelanggan
                        </button>
                    </h2>
                    <div id="collapseDataPelanggan" class="accordion-collapse collapse"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            ...
                            <form action="/updating/hapus_pelanggan" method="get">
                                @csrf
                                @method('delete')
                                <a href="#" class="btn btn-danger col-sm-4 mb-2 button-delete-pelanggan"
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-lg-4">
                                                        <label class="form-label">No HP StakeHolder</label>
                                                        <div class="input-group input-group-flat">
                                                            <input type="text" name="nohp_stakeholder"
                                                                id="nohp_stakeholder" value="{{ $s->nohp_stakeholder }}"
                                                    ...
                                                    <div class="mb-3 col-lg-4">
                                                        <label class="form-label">No HP PIC Lapangan</label>
                                                        <div class="input-group input-group-flat">
                                                            <input type="text" name="nohp_piclapangan"
                                                                id="nohp_piclapangan" value="{{ $s->nohp_piclapangan }}"
        ...
        <div class="card mt-2 border border-info">
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseDataTrafo" aria-expanded="false" aria-controls="collapseDataTrafo">
                        Data Trafo
                    </button>
                </h2>
                <div id="collapseDataTrafo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <form action="/updating/hapus_trafo" method="get">
                            @csrf
                            @method('delete')
                            <a href="#" class="btn btn-danger col-sm-4 mb-2 button-delete-trafo"
    ...
    <div class="card mt-2 border border-info">
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseDataUnit" aria-expanded="false" aria-controls="collapseDataUnit">
                    Data Unit
                </button>
            </h2>
    ...
    <div class="card mt-2 border border-info">
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseWANotif" aria-expanded="false" aria-controls="collapseWANotif">
                    WA Notif
                </button>
            </h2>
