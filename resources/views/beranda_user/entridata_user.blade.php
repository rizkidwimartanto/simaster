                    ...
                    <form action="/input_pelanggan_app" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control @error('jenis_meter') is-invalid @enderror" name="jenis_meter"
                                ...
                                <option value="Prabayar" {{ old('jenis_meter') == 'Prabayar' ? 'selected' : '' }}>Prabayar
                                </option>
                                <option value="Pascabayar" {{ old('jenis_meter') == 'Pascabayar' ? 'selected' : '' }}>
                                    Pascabayar
                                </option>
                            </select>
                            @error('jenis_meter')
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control @error('merk_meter') is-invalid @enderror" name="merk_meter"
                                ...
                                <option value="Actaris" {{ old('merk_meter') === 'Actaris' ? 'selected' : '' }}>Actaris
                                </option>
                                <option value="Cannet" {{ old('merk_meter') === 'Cannet' ? 'selected' : '' }}>Cannet
                                </option>
                                <option value="Conlog" {{ old('merk_meter') === 'Conlog' ? 'selected' : '' }}>Conlog
                                </option>
                                <option value="Fuji" {{ old('merk_meter') === 'Fuji' ? 'selected' : '' }}>Fuji</option>
                                <option value="Hexing" {{ old('merk_meter') === 'Hexing' ? 'selected' : '' }}>Hexing
                                </option>
                                <option value="Itron" {{ old('merk_meter') === 'Itron' ? 'selected' : '' }}>Itron</option>
                                <option value="Landis" {{ old('merk_meter') === 'Landis' ? 'selected' : '' }}>Landis
                                </option>
                                <option value="Melcoinda" {{ old('merk_meter') === 'Melcoinda' ? 'selected' : '' }}>
                                    Melcoinda</option>
                                <option value="Prima" {{ old('merk_meter') === 'Prima' ? 'selected' : '' }}>Prima</option>
                                <option value="Sanxing" {{ old('merk_meter') === 'Sanxing' ? 'selected' : '' }}>Sanxing
                                </option>
                                <option value="SmartMeter" {{ old('merk_meter') === 'SmartMeter' ? 'selected' : '' }}>
                                    SmartMeter
                                </option>
                            </select>
                            @error('merk_meter')
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control @error('merk_mcb') is-invalid @enderror" name="merk_mcb"
                                ...
                                <option value="ELEKTRO" {{ old('merk_mcb') === 'ELEKTRO' ? 'selected' : '' }}>ELEKTRO
                                </option>
                                <option value="HPL" {{ old('merk_mcb') === 'HPL' ? 'selected' : '' }}>HPL</option>
                                <option value="LG" {{ old('merk_mcb') === 'LG' ? 'selected' : '' }}>LG</option>
                                <option value="MCCB / HAGER" {{ old('merk_mcb') === 'MCCB / HAGER' ? 'selected' : '' }}>
                                    MCCB / HAGER
                                </option>
                                ...
                                <option value="MERLIN GERIN" {{ old('merk_mcb') === 'MERLIN GERIN' ? 'selected' : '' }}>
                                    MERLIN GERIN
                                </option>
                                <option value="OSAKI" {{ old('merk_mcb') === 'OSAKI' ? 'selected' : '' }}>OSAKI</option>
                                <option value="SCHNEIDER" {{ old('merk_mcb') === 'SCHNEIDER' ? 'selected' : '' }}>SCHNEIDER
                                </option>
                            </select>
                            @error('merk_mcb')
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control @error('no_segel') is-invalid @enderror" name="no_segel"
                                id="no_segel" type="text" value="{{ old('no_segel') }}">
                            @error('no_segel')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control @error('no_gardu') is-invalid @enderror" name="no_gardu"
                                id="no_gardu" type="text" value="{{ old('no_gardu') }}">
                            @error('no_gardu')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
