...
@section('content')
        ...
        <table class="table table-bordered tabel-app mt-2" id="tabel_rise_pole">
            ...
            <tbody>
                ...
                @foreach ($data_keypoint as $keypoint)
                    @if ($keypoint->jenis_keypoint === 'Rise Pole')
                        <tr>
                            <td width="5%">{{ $no++ }}</td>
                            <td width="20%">{{ $keypoint->penyulang }}</td>
                            <td width="20%">{{ $keypoint->absw }}</td>
                            <td width="5%">
                                        ...
                                        <form action="/edit_keypoint/{{ $keypoint->id }}" method="post">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-3" id="modalTambahKeypointLabel">Edit Data
                                                        Keypoint
                                                    </h1>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="input-group input-group-flat">
                                                            <input class="form-control" name="nomor_tiang" id="nomor_tiang"
                                                                type="text" value="{{ $keypoint->nomor_tiang }}">
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="input-group input-group-flat">
                                                            <input class="form-control" name="kondisi_keypoint"
                                                                id="kondisi_keypoint"
                                                                value="{{ $keypoint->kondisi_keypoint }}" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="input-group input-group-flat">
                                                            <input class="form-control" name="setting_ocr" id="setting_ocr"
                                                                type="text" value="{{ $keypoint->setting_ocr }}">
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            template_tabel('#tabel_rise_pole');
        });
    </script>
@endsection
