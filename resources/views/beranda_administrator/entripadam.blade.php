    ...
    <div class="container-fluid mt-3">
        ...
        <div class="col-lg-12">
            <div class="card border border-info p-3 mt-4">
                ...
                <form action="{{route('insertentripadam')}}" method="post" id="entriPadamForm">
                    @csrf
                    <div class="mb-3">
                        <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="{{route('transaksi_aktif')}}" class="btn btn-info col-12 mt-3"><i class="fa-solid fa-arrow-right fa-lg"
