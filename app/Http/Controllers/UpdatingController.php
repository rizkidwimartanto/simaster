...
class UpdatingController extends Controller
{
    public function index()
    {
        $data = [
            ...
            'data_pelanggan_app' => DB::table('entri_pelanggan_app')->select('id','id_pelanggan', 'nama_pelanggan', 'tarif', 'daya', 'alamat', 'latitude', 'longitude', 'jenis_meter', 'merk_meter', 'tahun_meter', 'merk_mcb', 'ukuran_mcb', 'no_segel', 'no_gardu', 'sr_deret' ,'catatan', 'created_at')->get(),
